/* Toe Reading service worker · v9.16.3 (vormen versmalling en dunneaanzet; v9.16.2 duo-verhaal zonder markdown; v9.16.1 duo-hint; v9.16.0 meekijkfoto; v9.15.9 fix: navigatie naar andere pagina's overschreef de offline-kopie van index.html)
   Strategie:
...
const CACHE = 'tenenspiegel-v9.16.3';
const KERN = [
  './',
  './index.html',
