/* Toe Reading service worker · v9.15.6 (fix: navigatie naar andere pagina's overschreef de offline-kopie van index.html)
   Strategie:
...
const CACHE = 'tenenspiegel-v9.15.6';
const KERN = [
  './',
  './index.html',
    ...
    e.respondWith(
      fetch(req)
        .then((antwoord) => {
          ...
          /* v9.15.6: alleen de app zelf onder ./index.html bewaren; andere pagina's (pricing, beheer) onder hun eigen url */
